...
class DPDN(nn.Module):
    ...
    def forward(self, mosaicked, sparse_image, conv_filter_M, conv_filter_H):

        Im_raw = F.conv2d(mosaicked, conv_filter_M, padding=2) / 64.0
        ...
        Demosaic = F.conv2d(sparse_image, conv_filter_H, padding=3) / 16.0
