...
parser.add_argument("--dataset", default="/home/dell/wyz/workGJS/DDM-Net/checkpoint/Model2Onnx/GJS25", type=str, help="dataset name, Default: CAVE")
parser.add_argument("--scale", default=5, type=int, help="msfa_size, Default: 5")
        ...
        for i in range(1):
            for image_name in sorted(os.listdir(image_list)):
                ...
                for index in range(25):
                    ...
                    output_path = "/home/dell/wyz/workGJS/DDM-Net/checkpoint/Fine_Tuning_Train_Model_Onnx/GJS_25_main_model_epoch_2000.onnx"
