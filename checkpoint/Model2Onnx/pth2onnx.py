...
sys.path.append("/home/dell/wyz/workGJS/DDM-Net")

from My_function import reorder_imec, reorder_2filter
from networks.DPDN2Onnx import DPDN
...
parser.add_argument("--model", default="/home/dell/wyz/workGJS/DDM-Net/checkpoint/Fine_Tuning_Train_Model/TT31_final_model_epoch_4000.pth", type=str, help="model path")
parser.add_argument("--dataset", default="/home/dell/wyz/workGJS/DDM-Net/checkpoint/Model2Onnx/TT31", type=str, help="dataset name, Default: CAVE")
        ...
        for i in range(1):
            for image_name in sorted(os.listdir(image_list)):
                ...
                for index in range(16):
                    ...
                    # output_path = "/home/dell/wyz/workGJS/DDM-Net/checkpoint/Fine_Tuning_Train_Model_Onnx/CAVE_final_model_epoch_4000.onnx"
                    output_path = "/home/dell/wyz/workGJS/DDM-Net/checkpoint/Fine_Tuning_Train_Model_Onnx/TT31_final_model_epoch_4000.onnx"

                    torch.onnx.export(model, (raw, sparse_image, conv_filter_M, conv_filter_H), output_path, verbose=True)
